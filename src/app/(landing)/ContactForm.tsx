...
export default function ContactForm() {
  ...
  if (isSuccess) {
    return (
      <div className="rounded-2xl bg-green-50 dark:bg-green-900/20 p-8 text-center mx-auto max-w-md my-12">
  ...
  return (
    <>
    <h1 className="mb-6 text-3xl font-bold text-center">ติดต่อเรา</h1>
    <form onSubmit={handleSubmit} className="space-y-6 mx-auto max-w-lg my-12">
      {error && (
